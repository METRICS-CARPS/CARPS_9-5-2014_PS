...
^Chi squared how many correct classifications compared to how many incorrect classifications. 
multiply each response by 9 since there were 9 trials - then use that to get the number of correct classifications (i.e. .778 = 7 trials right, which means 2 trials wrong), then sum across participants to get # of correct answers (and # of incorrect answers), then for the chi squared test 
chisq.test(x=c(success, failure))
...
Looking at all four age groups combined for each of the three attributes. 
