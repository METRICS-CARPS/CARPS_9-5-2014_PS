...
#according to this we get a different output from the authors - that there is no difference between 5-6 year olds and 3-4 year olds, and that the other age groups
#also don't know how to get d value for this 

#looking at Tukey HSD correction for nice
TukeyHSD(aovnice)
...
#according to this we get the same outcome as the authors, that 3-4 year olds were less consistent than other age groups (all ps <.01) but could not get the ds 
