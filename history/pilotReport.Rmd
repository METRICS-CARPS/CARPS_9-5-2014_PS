...
```{r}
reportObject <- reproCheck(reportedValue = "1.08", obtainedValue = 1.41, valueType = 'd')
```
...
We did find one inconsistency in the reported F-statistic's value:

```{r}
reportObject <- reproCheck(reportedValue = "17.91", obtainedValue = 17.95, valueType = 'F')
```
...
```{r}
reportObject <- reproCheck(reportedValue = "0.01", obtainedValue = 0.0465, valueType = 'p')
```
...
```{r}
reportObject <- reproCheck(reportedValue = "0.23", obtainedValue = 0.0378, valueType = 'p')
```
...
*5-6 year olds compared to adults*- 
```{r}
reportObject <- reproCheck(reportedValue = "0.23", obtainedValue = 0.0047, valueType = 'p')
```

*7-10 year olds compared to adults*-

```{r}
reportObject <- reproCheck(reportedValue = "0.23", obtainedValue = 0.0532, valueType = 'p')
```
...
```{r}
reportObject <- reproCheck(reportedValue = "0.59", obtainedValue = 0.602, valueType = 'd')
```
...
```{r}
reportObject <- reproCheck(reportedValue = "0.40", obtainedValue = 0.422, valueType = 'd')
```
